...
const ProjectMenu = () => {
  ...
  return (
    <div className="w-full mt-20 scroll-smooth">
      ...
      <div className="fixed md:sticky z-30 bottom-0 md:top-0 w-full md:mt-20 h-13 flex bg-neutral-800">
        <button
          onClick={scrollLeft}
          className="xl:hidden w-10 cursor-pointer h-full shrink-0 bg-neutral-700 px-2"
        >
        ...
        <button
          onClick={scrollRight}
          className="xl:hidden w-10 cursor-pointer h-full shrink-0 bg-neutral-700 p-2"
        >
          ...
          >
            ...
            <div className="gap-5 grid lg:grid-cols-2 mt-6">
              {tech.projects.map((project) => (
                <div key={project.projectname} className="group relative w-full bg-neutral-900 border-[1px] border-neutral-800 rounded-lg overflow-hidden">
